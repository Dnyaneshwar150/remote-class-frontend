...
const BackIcon: React.FC<IconProps> = ({
  ...
  ...props
    ...
    return (
        <svg width={width} height={height} viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g filter="url(#filter0_d_1_2457)">
        <circle cx="24" cy="24" r="23" fill="white" stroke="#18191F" stroke-width="2"/>
        <path d="M26.6666 32L18.6666 24L26.6666 16" stroke="#18191F" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
        <defs>
        <filter id="filter0_d_1_2457" x="0" y="0" width="48" height="50" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
